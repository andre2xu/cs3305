...
window.addEventListener('load', () => {
    ...
    const railing1 = new SemiSolid(PIXI.Texture.from('assets/foyer/railing.png'), 0, 0, 96, 48);
    railing1.setPosition(0, 110);
    railing1.modifyCollisionBoundary(5, 5, 5, 5);

    const railing2 = new SemiSolid(PIXI.Texture.from('assets/foyer/railing.png'), 0, 0, 96, 48);
    railing2.setPosition(40, 110);
    railing2.modifyCollisionBoundary(5, 5, 5, 5);

    const railing3 = new SemiSolid(PIXI.Texture.from('assets/foyer/railing.png'), 0, 0, 96, 48);
    railing3.setPosition(195, 110);
    railing3.modifyCollisionBoundary(5, 5, 5, 5);

    const railing4 = new SemiSolid(PIXI.Texture.from('assets/foyer/railing.png'), 0, 0, 96, 48);
    railing4.setPosition(235, 110);
    railing4.modifyCollisionBoundary(5, 5, 5, 5);

    const railing5 = new SemiSolid(PIXI.Texture.from('assets/foyer/railing.png'), 0, 0, 96, 48);
    railing5.setPosition(275, 110);
    railing5.modifyCollisionBoundary(5, 5, 5, 5);

    const railing6 = new SemiSolid(PIXI.Texture.from('assets/foyer/railing.png'), 0, 0, 96, 48);
    railing6.setPosition(430, 110);
    railing6.modifyCollisionBoundary(5, 5, 5, 5);

    const railing7 = new SemiSolid(PIXI.Texture.from('assets/foyer/railing.png'), 0, 0, 96, 48);
