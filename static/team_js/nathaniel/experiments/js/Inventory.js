...
export class Inventory {
    ...
    addItem(item){ //Adding the same item twice does not work, must be something with how pixijs containers operate, so if we have to add two of the same item it has to be two different instances
    ...
    // isOverwrite determines if the adding of the item should overwrite the item that was
    // in that position or fail to add if there is already an item there
